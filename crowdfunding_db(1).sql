...
INSERT INTO `fundraisers` VALUES (1,'John Doe','Support for local health clinic',5000.00,1500.00,'New York',1,1),(2,'Jane Smith','Fund education for underprivileged children',10000.00,3000.00,'Los Angeles',1,2),(3,'Mike Johnson','Planting trees in the community',2000.00,800.00,'San Francisco',1,3),(4,'Emily Davis','Support for animal shelter',7500.00,2000.00,'Chicago',1,5),(5,'Alex Brown','Community center renovation',12000.00,5000.00,'Houston',1,4),(6,'Sarah Wilson','Educational materials for schools',8000.00,2500.00,'Phoenix',1,2),(7,'David Lee','Local park clean-up and restoration',3000.00,1200.00,'Seattle',0,3),(8,'Linda Garcia','Animal rescue and adoption program',6000.00,3500.00,'Miami',0,5),(9,'James Taylor','Scholarships for college students',15000.00,4000.00,'Philadelphia',0,2),(10,'Maria Rodriguez','Food drive for homeless',5000.00,1500.00,'Dallas',0,4);
...
-- Dump completed on 2024-09-29 13:58:24
